<?php
	...
	else
	{
		...
		if($_GET['mode'] == 1)
		{
			...
			$query = $db->prepare("insert into vendor_registration_codes(vendor_id, registration_code, date_time)
			...
			$query2 = $db->prepare("select email_address from temporary_vendors where vendor_id=:id");
